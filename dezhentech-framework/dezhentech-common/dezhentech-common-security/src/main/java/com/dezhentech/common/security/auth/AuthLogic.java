package com.dezhentech.common.security.auth;

import cn.hutool.core.collection.CollectionUtil;
import cn.hutool.core.util.StrUtil;
import cn.hutool.extra.spring.SpringUtil;
import com.dezhentech.common.core.exceptions.ServiceException;
import com.dezhentech.common.core.exceptions.auth.NotLoginException;
...
import com.dezhentech.common.security.annotation.Logical;
 ...
 * @title: com.dezhentech.common.security.auth.AuthLogic
 * @author: yingfan.cui@dezhentech.com
 * @create: 2022/11/08 11:23:29
 * @version: 1.0.0
 **/
...
//        SecurityContextHolder.setPermission(StringUtils.join(requiresPermissions.value(), ","));
    ...
    public void checkRoleAnd(String... roles) {
        ...
        if (CollectionUtil.isNotEmpty(roleList)) {
            ...
            throw new ServiceException("此用户没有分配任何角色");
        }
    }

package com.dezhentech.common.core.utils.serializer;
 ...
 * @description: Kryo 工具
 * <p/>
 * @title: com.dezhentech.common.core.utils.serializer.DzKryoUtil
 * @author: xu.zhang@dezhentech.com
 * @create: 2022/11/09 01:20:10
 * @version: 1.0.0
 **/
public class DzKryoUtil {
...
//        }
    	return DzBase64Util.encode(writeToByteArray(obj));
    }
...
//            throw new IllegalStateException(e);
//        }
    	return readFromByteArray(DzBase64Util.decode(str));
    }
...
//            throw new IllegalStateException(e);
//        }
    	return DzBase64Util.encode(writeObjectToByteArray(obj));
    }
...
//        }
    	...
    	return readObjectFromByteArray(DzBase64Util.decode(str), clazz);
    }
}
